...
export default async function PlanPage({
  ...
  const dict: StudioDict = {
    ...
    worldEmptyUnscheduled: t("studio.world.empty_unscheduled", { n: "{n}", reason: "{reason}" }),
    worldEmptyHint: t("studio.world.empty_hint"),
    worldOpenGantt: t("studio.world.open_gantt"),
