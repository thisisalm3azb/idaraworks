...
export const EXPORT_CATALOGUE: readonly ExportCatalogueEntry[] = [
  ...
  data({
    ...
    entitlementFeature: null,
    entitlementNote: "Never gated (FR-9: reads/exports always available).",
    redaction: "estimated_value_minor blanked unless price-privileged.",
    availability: "available",
  }),
  data({
    id: "data_opportunities",
  ...
  data({
    id: "data_sales_activities",
    nameEn: "Sales activities",
    nameAr: "الأنشطة البيعية",
