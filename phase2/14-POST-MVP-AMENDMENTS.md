...
| 2026-09-04 | H29 shipped: the country-pack engine, establishments, effective-dated versions with adoption and an impact simulator, the Country Readiness Centre (six states, never averaged), one electronic-invoicing framework with fail-closed ZATCA and UAE adapters, the complete Spanish catalogue with translation governance, and country-aware imports and exports. Migrations 0130-0133. Both flags stay OFF: activation waits on the owner actions in `docs/H29-REPORT.md` section 4. No tax filing, no authority submission, no compliance claim. | Owner |
